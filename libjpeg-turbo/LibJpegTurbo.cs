...
namespace LibJpegTurbo
{
    ...
    public static unsafe partial class TurboJpeg
    {
        ...
        public static readonly TJRegion TJUNCROPPED = new TJRegion
        {
            x = 0,
            y = 0,
            w = 0,
        ...
        public static readonly TJScalingFactor TJUNSCALED = new TJScalingFactor
        {
            num = 1,
            denom = 1,
        };
